...
function useFieldArray({ control, name }) {
    ...
    const memoizedDefaultValues = React.useMemo(() => get(defaultValuesRef.current, name, []), 
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [name]);
    const [fields, setField] = React.useState(mapIds(memoizedDefaultValues));
...
const ErrorMessage = ({ as: InnerComponent, errors, name, children, }) => {
    ...
    return InnerComponent ? (React.isValidElement(InnerComponent) ? (React.cloneElement(InnerComponent, props)) : (React.createElement(InnerComponent, Object.assign({}, props)))) : (React.createElement(React.Fragment, Object.assign({}, props)));
};
